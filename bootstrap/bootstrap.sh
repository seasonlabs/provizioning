...
if [ "$var" == "Ubuntu 11.04 \n \l" ]
then
curl https://raw.github.com/gist/6a44de628fc13f4dc0c2/natty.sources.list -o sources.list
else
curl https://raw.github.com/gist/6a44de628fc13f4dc0c2/lucid.sources.list -o sources.list
fi
